...
public class Ejercicio18_2 {
	...
	public static void main(String[] args) {
		...
		sc.close();
		// Con el metodo SET le damos los valores que tienen las variables al OBJETO (en
		// este caso alumno):
		alumno.setDni(dni);
		alumno.setEdad(edad);
		...
		// Con el metodo GET lo usamos para que nos devuelva el valor de cierto atributo
		// de cierto Objeto:
